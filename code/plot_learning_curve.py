...
It uses the output of the caffe log to generate this plot.
To use: python3 plot_learning_curve <log path> <figure output path>
"""

plt.style.use('ggplot')


caffe_path = '/opt/movidius/caffe/'
model_log_path = sys.argv[1]
figure_output_path = sys.argv[2]
